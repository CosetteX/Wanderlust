...
public class ScheduleListAdapter extends BaseQuickAdapter<Bar_2_Item_new, BaseViewHolder> {

    public ScheduleListAdapter(@Nullable List<Bar_2_Item_new> data) {
        super(R.layout.item_schedule_list,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, Bar_2_Item_new item) {
